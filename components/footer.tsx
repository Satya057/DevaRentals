    ...
    <footer className="bg-foreground text-background">
      <div className="w-[90%] mx-auto py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center gap-3 mb-6">
              ...
              <div className="flex flex-col">
                <span className="text-xl font-sans font-normal tracking-tight text-background">
                  DEVA RENTALS
                </span>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-sans font-normal mb-6">Quick Links</h4>
          ...
          {/* Services */}
          <div>
            <h4 className="text-lg font-sans font-normal mb-6">Our Services</h4>
            <ul className="space-y-3">
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-lg font-sans font-normal mb-6">Contact Info</h4>
