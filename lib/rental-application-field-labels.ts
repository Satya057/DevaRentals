...
export const RENTAL_APPLICATION_FIELD_LABELS: Record<string, string> = {
  ...
  prevLandlordName: "Current landlord name",
  prevLandlordPhone: "Current landlord phone",
  prevPresentAddress: "Current present address",
  prevTimeAtLocation: "Time at current location",
  prevMonthlyRent: "Current monthly rent",
